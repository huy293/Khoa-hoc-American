...
const PEOPLE_DATA = [
    {
        id: "thomas-nguyen",
        quote: {
            text: "Where experience becomes artistry, and artistry becomes a career.",
            author: "KATHLEEN",
        },
        name: "Thomas Nguyen",
        role: "Master Trainer",
        ...
        imageAlt: "Thomas Nguyen",
    },
    {
        id: "kathleen",
        quote: {
            text: "Confidence grows through practice, creativity, and experience",
            author: "KATHLEEN",
        },
        name: "Kathleen",
        role: "Master Trainer",
                ...
                <div className={styles["about-people__container"]}>
                    ...
                    <div className={styles["about-people__header"]}>
                        <div className={styles["about-people__header-left"]}>
                            <p className={styles["about-people__eyebrow"]}>People</p>
                            <span className={styles["about-people__divider"]}></span>
                            <h2 className={styles["about-people__title"]}>Meet Teaching & Training Team</h2>
                        </div>

                        <div className={styles["about-people__header-right"]}>
                            <p className={styles["about-people__description"]}>
                                Advanced Skincare · Facial Techniques · Beauty Aesthetics · Professional Practice
                            </p>
                    ...
                    <div className={styles["about-people__content"]}>
                        <div className={styles["about-people__grid"]}>
                            {PEOPLE_DATA.map((person) => (
                                <div key={person.id} className={styles["about-people__card"]}>
                                    {/* Top: Quote Box */}
                                        ...
                                        <div className={styles["about-people__profile-info"]}>
                                            ...
                                            <ul className={styles["about-people__profile-tags"]}>
                                                {person.tags.map((tag, index) => (
                                                    <li key={index} className={styles["about-people__profile-tag"]}>
                                                        <span>★</span> {tag}
                                                    </li>
                                                ))}
                                            </ul>
