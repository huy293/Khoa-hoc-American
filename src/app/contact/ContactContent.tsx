                    ...
                    <div className={styles['contact__container']}>
                        ...
                        <div className={styles['contact__info']}>
                            ...
                            <div className={styles['contact__schedule']}>
                                <p className={styles['contact__schedule-title']}>OPENING HOURS &amp; LOCATION</p>
                                ...
                                <ul className={styles['contact__schedule-list']}>
                                    <li className={styles['contact__schedule-item']}>
                                        <span className={styles['contact__schedule-label']}>MONDAY – SATURDAY</span>
                                        <span className={styles['contact__schedule-value']}>10:00 AM – 7:00 PM</span>
                                    </li>
                                    <li className={styles['contact__schedule-item']}>
                                        <span className={styles['contact__schedule-label']}>CAMPUS</span>
                                        <span className={styles['contact__schedule-value']}>6441 Westheimer Rd, Houston, TX 77057</span>
                                    </li>
                                </ul>
                            </div>

                            <div className={styles['contact__socials']}>
                                <a href="#" className={styles['contact__social-link']} aria-label="Facebook">
                                ...
                                <a href="#" className={styles['contact__social-link']} aria-label="Instagram">
                                    <svg className={styles['contact__social-icon']} viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <a href="#" className={styles['contact__social-link']} aria-label="Twitter">
                                    <svg className={styles['contact__social-icon']} viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <form className={styles['contact__form']} onSubmit={(e) => e.preventDefault()}>
                                        ...
                                        <div className={styles['contact__form-group']}>
                                            ...
                                            <div className={styles['contact__form-select-wrapper']}>
                                                <select className={styles['contact__form-select']} defaultValue="">
