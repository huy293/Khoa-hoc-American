...
export const metadata: Metadata = {
    title: "Tài nguyên & Giáo trình | Couture Beauty Academy",
    description: "Kho tài liệu, giáo trình và kiến thức chuyên ngành thẩm mỹ y khoa",
};
...
export default async function ResourcesPage() {
    ...
    try {
        ...
        if (wpResources && wpResources.length > 0) {
            ...
            // Fallback sang blog posts nếu endpoint resources chưa có dữ liệu
