                        ...
                        <div className={styles["cart-page__list"]}>
                            {items.length === 0 ? (
                                <div style={{ padding: "40px 20px", textAlign: "center", width: "100%" }}>
                                    <p style={{ fontSize: "16px", color: "var(--text-color, #777)", marginBottom: "16px" }}>
                                    ...
                                    <Link
                                        ...
                                        style={{
                                            ...
                                            padding: "10px 24px",
                                            background: "var(--gold-main, #AF8861)",
                                            color: "#fff",
                                            borderRadius: "6px",
                                            fontWeight: 600,
                                            textDecoration: "none",
                                    ...
                                    <article key={item.id} className={styles["cart-item"]}>
                                        ...
                                        <div className={styles["cart-item__bottom-row"]}>
                                            <div className={styles["cart-item__stock-info"]}>
                                                ...
                                                <span
                                                    className={`${styles["cart-item__stock-status"]} ${(item.stock ?? 20) <= 5
                                                            ? styles["cart-item__stock-status--low"]
                                                            : ""
                                                        }`}
                                                >
                                                    In stock: {item.stock ?? 20} product
                                                </span>
                                            </div>
                                    ...
                                    <div className={styles["cart-summary__table-wrapper"]}>
                                        <table className={styles["cart-summary__table"]}>
                                            ...
                                            <tbody className={styles["cart-summary__table-body"]}>
                                                {items.length === 0 ? (
                                                    <tr className={styles["cart-summary__table-tr"]}>
                                                        <td colSpan={3} style={{ textAlign: "center", padding: "16px", color: "var(--text-color, #777)" }}>
                                                            No items in cart
                                                        </td>
                                                    </tr>
                                                ) : (
                                    ...
                                    <ul className={styles["cart-summary__total-list"]}>
                                        ...
                                        {memberDiscount > 0 && (
                                            <li className={styles["cart-summary__total-item"]}>
                                                ...
                                                <span className={styles["cart-summary__total-value"]} style={{ color: "green" }}>
